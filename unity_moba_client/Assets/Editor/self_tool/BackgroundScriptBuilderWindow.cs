...
namespace BackgroundScriptBuilder
{
    ...
    { 
        [SerializeField]
        private static BackgroundScriptBuilderApplication builderApp = null;

        [MenuItem("MyMenu/Background Script Builder", false, 100)]
        public static void Init()
        {
            BackgroundScriptBuilderWindow window = (BackgroundScriptBuilderWindow)EditorWindow.GetWindow(typeof(BackgroundScriptBuilderWindow));
            window.Show();
        }
    ...
    public class BackgroundScriptBuilderApplication : ScriptableObject
    {
        ...
        private string settingsPrefix = "UnityBackgroundBuild";
