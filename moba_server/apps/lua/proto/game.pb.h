...
class WorldUChipRankInfo;
class WorldUChipRankInfoDefaultTypeInternal;
extern WorldUChipRankInfoDefaultTypeInternal _WorldUChipRankInfo_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::WorldUChipRankInfo* Arena::CreateMaybeMessage<::WorldUChipRankInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class WorldUChipRankInfo :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:WorldUChipRankInfo) */ {
 public:
  WorldUChipRankInfo();
  virtual ~WorldUChipRankInfo();

  WorldUChipRankInfo(const WorldUChipRankInfo& from);
  WorldUChipRankInfo(WorldUChipRankInfo&& from) noexcept
    : WorldUChipRankInfo() {
    *this = ::std::move(from);
  }

  inline WorldUChipRankInfo& operator=(const WorldUChipRankInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline WorldUChipRankInfo& operator=(WorldUChipRankInfo&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const WorldUChipRankInfo& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const WorldUChipRankInfo* internal_default_instance() {
    return reinterpret_cast<const WorldUChipRankInfo*>(
               &_WorldUChipRankInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(WorldUChipRankInfo& a, WorldUChipRankInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(WorldUChipRankInfo* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline WorldUChipRankInfo* New() const final {
    return CreateMaybeMessage<WorldUChipRankInfo>(nullptr);
  }

  WorldUChipRankInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<WorldUChipRankInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const WorldUChipRankInfo& from);
  void MergeFrom(const WorldUChipRankInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(WorldUChipRankInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "WorldUChipRankInfo";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:WorldUChipRankInfo)
 private:
  class _Internal;
...
class GetWorldRankUchipRes :
 ...
 public:
  ...
  // repeated .WorldUChipRankInfo rank_info = 2;
  int rank_info_size() const;
  private:
  int _internal_rank_info_size() const;
  public:
  void clear_rank_info();
  ::WorldUChipRankInfo* mutable_rank_info(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::WorldUChipRankInfo >*
      mutable_rank_info();
  private:
  const ::WorldUChipRankInfo& _internal_rank_info(int index) const;
  ::WorldUChipRankInfo* _internal_add_rank_info();
  public:
  const ::WorldUChipRankInfo& rank_info(int index) const;
  ::WorldUChipRankInfo* add_rank_info();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::WorldUChipRankInfo >&
      rank_info() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::WorldUChipRankInfo > rank_info_;
  ::PROTOBUF_NAMESPACE_ID::int32 status_;
  friend struct ::TableStruct_game_2eproto;
};
// -------------------------------------------------------------------
...
class GameStart :
 ...
 public:
  ...
  enum : int {
    kPlayersMatchInfosFieldNumber = 1,
  };
  // repeated .PlayerMatchInfo players_match_infos = 1;
  int players_match_infos_size() const;
  private:
  int _internal_players_match_infos_size() const;
  public:
  void clear_players_match_infos();
  ::PlayerMatchInfo* mutable_players_match_infos(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PlayerMatchInfo >*
      mutable_players_match_infos();
  private:
  const ::PlayerMatchInfo& _internal_players_match_infos(int index) const;
  ::PlayerMatchInfo* _internal_add_players_match_infos();
  public:
  const ::PlayerMatchInfo& players_match_infos(int index) const;
  ::PlayerMatchInfo* add_players_match_infos();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PlayerMatchInfo >&
      players_match_infos() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PlayerMatchInfo > players_match_infos_;
  friend struct ::TableStruct_game_2eproto;
};
// -------------------------------------------------------------------
...
class FrameOpts :
 ...
 public:
  ...
  // required int32 old_frameid = 1;
  bool has_old_frameid() const;
  private:
  bool _internal_has_old_frameid() const;
  public:
  void clear_old_frameid();
  ::PROTOBUF_NAMESPACE_ID::int32 old_frameid() const;
  void set_old_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_old_frameid() const;
  void _internal_set_old_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 old_frameid_;
  friend struct ::TableStruct_game_2eproto;
};
// -------------------------------------------------------------------
...
class LogicFrame :
 ...
 public:
  ...
  // required int32 cur_frameid = 1;
  bool has_cur_frameid() const;
  private:
  bool _internal_has_cur_frameid() const;
  public:
  void clear_cur_frameid();
  ::PROTOBUF_NAMESPACE_ID::int32 cur_frameid() const;
  void set_cur_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_cur_frameid() const;
  void _internal_set_cur_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 cur_frameid_;
  friend struct ::TableStruct_game_2eproto;
};
// -------------------------------------------------------------------
...
class NextFrameOpts :
 ...
 public:
  ...
  enum : int {
    kNextOptsFieldNumber = 5,
    kNextFrameidFieldNumber = 1,
    kZidFieldNumber = 2,
    kMatchidFieldNumber = 3,
    kSeatidFieldNumber = 4,
  };
  // repeated .OptionEvent next_opts = 5;
  int next_opts_size() const;
  private:
  int _internal_next_opts_size() const;
  public:
  void clear_next_opts();
  ::OptionEvent* mutable_next_opts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::OptionEvent >*
      mutable_next_opts();
  private:
  const ::OptionEvent& _internal_next_opts(int index) const;
  ::OptionEvent* _internal_add_next_opts();
  public:
  const ::OptionEvent& next_opts(int index) const;
  ::OptionEvent* add_next_opts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::OptionEvent >&
      next_opts() const;

  // required int32 next_frameid = 1;
  bool has_next_frameid() const;
  private:
  bool _internal_has_next_frameid() const;
  public:
  void clear_next_frameid();
  ::PROTOBUF_NAMESPACE_ID::int32 next_frameid() const;
  void set_next_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_next_frameid() const;
  void _internal_set_next_frameid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::OptionEvent > next_opts_;
  ::PROTOBUF_NAMESPACE_ID::int32 next_frameid_;
  ::PROTOBUF_NAMESPACE_ID::int32 zid_;
  ::PROTOBUF_NAMESPACE_ID::int32 matchid_;
  ::PROTOBUF_NAMESPACE_ID::int32 seatid_;
  friend struct ::TableStruct_game_2eproto;
...
// required string unick = 1;
inline bool WorldUChipRankInfo::_internal_has_unick() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool WorldUChipRankInfo::has_unick() const {
  return _internal_has_unick();
}
inline void WorldUChipRankInfo::clear_unick() {
  unick_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& WorldUChipRankInfo::unick() const {
  // @@protoc_insertion_point(field_get:WorldUChipRankInfo.unick)
  return _internal_unick();
}
inline void WorldUChipRankInfo::set_unick(const std::string& value) {
  _internal_set_unick(value);
  // @@protoc_insertion_point(field_set:WorldUChipRankInfo.unick)
}
inline std::string* WorldUChipRankInfo::mutable_unick() {
  // @@protoc_insertion_point(field_mutable:WorldUChipRankInfo.unick)
  return _internal_mutable_unick();
}
inline const std::string& WorldUChipRankInfo::_internal_unick() const {
  return unick_.GetNoArena();
}
inline void WorldUChipRankInfo::_internal_set_unick(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  unick_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void WorldUChipRankInfo::set_unick(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  unick_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:WorldUChipRankInfo.unick)
}
inline void WorldUChipRankInfo::set_unick(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  unick_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:WorldUChipRankInfo.unick)
}
inline void WorldUChipRankInfo::set_unick(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  unick_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:WorldUChipRankInfo.unick)
}
inline std::string* WorldUChipRankInfo::_internal_mutable_unick() {
  _has_bits_[0] |= 0x00000001u;
  return unick_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* WorldUChipRankInfo::release_unick() {
  // @@protoc_insertion_point(field_release:WorldUChipRankInfo.unick)
  if (!_internal_has_unick()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void WorldUChipRankInfo::set_allocated_unick(std::string* unick) {
  if (unick != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  unick_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), unick);
  // @@protoc_insertion_point(field_set_allocated:WorldUChipRankInfo.unick)
}

// required int32 uface = 2;
inline bool WorldUChipRankInfo::_internal_has_uface() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool WorldUChipRankInfo::has_uface() const {
  return _internal_has_uface();
}
inline void WorldUChipRankInfo::clear_uface() {
  uface_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::_internal_uface() const {
  return uface_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::uface() const {
  // @@protoc_insertion_point(field_get:WorldUChipRankInfo.uface)
  return _internal_uface();
}
inline void WorldUChipRankInfo::_internal_set_uface(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  uface_ = value;
}
inline void WorldUChipRankInfo::set_uface(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uface(value);
  // @@protoc_insertion_point(field_set:WorldUChipRankInfo.uface)
}

// required int32 usex = 3;
inline bool WorldUChipRankInfo::_internal_has_usex() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool WorldUChipRankInfo::has_usex() const {
  return _internal_has_usex();
}
inline void WorldUChipRankInfo::clear_usex() {
  usex_ = 0;
  _has_bits_[0] &= ~0x00000004u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::_internal_usex() const {
  return usex_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::usex() const {
  // @@protoc_insertion_point(field_get:WorldUChipRankInfo.usex)
  return _internal_usex();
}
inline void WorldUChipRankInfo::_internal_set_usex(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  usex_ = value;
}
inline void WorldUChipRankInfo::set_usex(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_usex(value);
  // @@protoc_insertion_point(field_set:WorldUChipRankInfo.usex)
}

// required int32 uvip = 4;
inline bool WorldUChipRankInfo::_internal_has_uvip() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool WorldUChipRankInfo::has_uvip() const {
  return _internal_has_uvip();
}
inline void WorldUChipRankInfo::clear_uvip() {
  uvip_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::_internal_uvip() const {
  return uvip_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::uvip() const {
  // @@protoc_insertion_point(field_get:WorldUChipRankInfo.uvip)
  return _internal_uvip();
}
inline void WorldUChipRankInfo::_internal_set_uvip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  uvip_ = value;
}
inline void WorldUChipRankInfo::set_uvip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uvip(value);
  // @@protoc_insertion_point(field_set:WorldUChipRankInfo.uvip)
}

// required int32 uchip = 5;
inline bool WorldUChipRankInfo::_internal_has_uchip() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool WorldUChipRankInfo::has_uchip() const {
  return _internal_has_uchip();
}
inline void WorldUChipRankInfo::clear_uchip() {
  uchip_ = 0;
  _has_bits_[0] &= ~0x00000010u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::_internal_uchip() const {
  return uchip_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorldUChipRankInfo::uchip() const {
  // @@protoc_insertion_point(field_get:WorldUChipRankInfo.uchip)
  return _internal_uchip();
}
inline void WorldUChipRankInfo::_internal_set_uchip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000010u;
  uchip_ = value;
}
inline void WorldUChipRankInfo::set_uchip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uchip(value);
  // @@protoc_insertion_point(field_set:WorldUChipRankInfo.uchip)
}
...
inline ::WorldUChipRankInfo* GetWorldRankUchipRes::mutable_rank_info(int index) {
  // @@protoc_insertion_point(field_mutable:GetWorldRankUchipRes.rank_info)
  return rank_info_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::WorldUChipRankInfo >*
GetWorldRankUchipRes::mutable_rank_info() {
  // @@protoc_insertion_point(field_mutable_list:GetWorldRankUchipRes.rank_info)
  return &rank_info_;
}
inline const ::WorldUChipRankInfo& GetWorldRankUchipRes::_internal_rank_info(int index) const {
  return rank_info_.Get(index);
}
inline const ::WorldUChipRankInfo& GetWorldRankUchipRes::rank_info(int index) const {
  // @@protoc_insertion_point(field_get:GetWorldRankUchipRes.rank_info)
  return _internal_rank_info(index);
}
inline ::WorldUChipRankInfo* GetWorldRankUchipRes::_internal_add_rank_info() {
  return rank_info_.Add();
}
inline ::WorldUChipRankInfo* GetWorldRankUchipRes::add_rank_info() {
  // @@protoc_insertion_point(field_add:GetWorldRankUchipRes.rank_info)
  return _internal_add_rank_info();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::WorldUChipRankInfo >&
...
// repeated .PlayerMatchInfo players_match_infos = 1;
inline int GameStart::_internal_players_match_infos_size() const {
  return players_match_infos_.size();
}
inline int GameStart::players_match_infos_size() const {
  return _internal_players_match_infos_size();
}
inline void GameStart::clear_players_match_infos() {
  players_match_infos_.Clear();
}
inline ::PlayerMatchInfo* GameStart::mutable_players_match_infos(int index) {
  // @@protoc_insertion_point(field_mutable:GameStart.players_match_infos)
  return players_match_infos_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PlayerMatchInfo >*
GameStart::mutable_players_match_infos() {
  // @@protoc_insertion_point(field_mutable_list:GameStart.players_match_infos)
  return &players_match_infos_;
}
inline const ::PlayerMatchInfo& GameStart::_internal_players_match_infos(int index) const {
  return players_match_infos_.Get(index);
}
inline const ::PlayerMatchInfo& GameStart::players_match_infos(int index) const {
  // @@protoc_insertion_point(field_get:GameStart.players_match_infos)
  return _internal_players_match_infos(index);
}
inline ::PlayerMatchInfo* GameStart::_internal_add_players_match_infos() {
  return players_match_infos_.Add();
}
inline ::PlayerMatchInfo* GameStart::add_players_match_infos() {
  // @@protoc_insertion_point(field_add:GameStart.players_match_infos)
  return _internal_add_players_match_infos();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PlayerMatchInfo >&
GameStart::players_match_infos() const {
  // @@protoc_insertion_point(field_list:GameStart.players_match_infos)
  return players_match_infos_;
}
...
// required int32 old_frameid = 1;
inline bool FrameOpts::_internal_has_old_frameid() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool FrameOpts::has_old_frameid() const {
  return _internal_has_old_frameid();
}
inline void FrameOpts::clear_old_frameid() {
  old_frameid_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 FrameOpts::_internal_old_frameid() const {
  return old_frameid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 FrameOpts::old_frameid() const {
  // @@protoc_insertion_point(field_get:FrameOpts.old_frameid)
  return _internal_old_frameid();
}
inline void FrameOpts::_internal_set_old_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  old_frameid_ = value;
}
inline void FrameOpts::set_old_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_old_frameid(value);
  // @@protoc_insertion_point(field_set:FrameOpts.old_frameid)
}
...
// required int32 cur_frameid = 1;
inline bool LogicFrame::_internal_has_cur_frameid() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool LogicFrame::has_cur_frameid() const {
  return _internal_has_cur_frameid();
}
inline void LogicFrame::clear_cur_frameid() {
  cur_frameid_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LogicFrame::_internal_cur_frameid() const {
  return cur_frameid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LogicFrame::cur_frameid() const {
  // @@protoc_insertion_point(field_get:LogicFrame.cur_frameid)
  return _internal_cur_frameid();
}
inline void LogicFrame::_internal_set_cur_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  cur_frameid_ = value;
}
inline void LogicFrame::set_cur_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cur_frameid(value);
  // @@protoc_insertion_point(field_set:LogicFrame.cur_frameid)
}
...
// required int32 next_frameid = 1;
inline bool NextFrameOpts::_internal_has_next_frameid() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool NextFrameOpts::has_next_frameid() const {
  return _internal_has_next_frameid();
}
inline void NextFrameOpts::clear_next_frameid() {
  next_frameid_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 NextFrameOpts::_internal_next_frameid() const {
  return next_frameid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 NextFrameOpts::next_frameid() const {
  // @@protoc_insertion_point(field_get:NextFrameOpts.next_frameid)
  return _internal_next_frameid();
}
inline void NextFrameOpts::_internal_set_next_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  next_frameid_ = value;
}
inline void NextFrameOpts::set_next_frameid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_next_frameid(value);
  // @@protoc_insertion_point(field_set:NextFrameOpts.next_frameid)
}
...
// repeated .OptionEvent next_opts = 5;
inline int NextFrameOpts::_internal_next_opts_size() const {
  return next_opts_.size();
}
inline int NextFrameOpts::next_opts_size() const {
  return _internal_next_opts_size();
}
inline void NextFrameOpts::clear_next_opts() {
  next_opts_.Clear();
}
inline ::OptionEvent* NextFrameOpts::mutable_next_opts(int index) {
  // @@protoc_insertion_point(field_mutable:NextFrameOpts.next_opts)
  return next_opts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::OptionEvent >*
NextFrameOpts::mutable_next_opts() {
  // @@protoc_insertion_point(field_mutable_list:NextFrameOpts.next_opts)
  return &next_opts_;
}
inline const ::OptionEvent& NextFrameOpts::_internal_next_opts(int index) const {
  return next_opts_.Get(index);
}
inline const ::OptionEvent& NextFrameOpts::next_opts(int index) const {
  // @@protoc_insertion_point(field_get:NextFrameOpts.next_opts)
  return _internal_next_opts(index);
}
inline ::OptionEvent* NextFrameOpts::_internal_add_next_opts() {
  return next_opts_.Add();
}
inline ::OptionEvent* NextFrameOpts::add_next_opts() {
  // @@protoc_insertion_point(field_add:NextFrameOpts.next_opts)
  return _internal_add_next_opts();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::OptionEvent >&
NextFrameOpts::next_opts() const {
  // @@protoc_insertion_point(field_list:NextFrameOpts.next_opts)
  return next_opts_;
}
