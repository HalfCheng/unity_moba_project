...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetUgameInfoRes_game_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetUgameInfoRes_game_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_game_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, uchip_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, uexp_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, uvip_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, uchip2_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, uchip3_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, udata1_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, udata2_),
  PROTOBUF_FIELD_OFFSET(::GetUgameInfoRes, udata3_),
  0,
  1,
  2,
  3,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_game_2eproto = {
  &descriptor_table_game_2eproto_initialized, descriptor_table_protodef_game_2eproto, "game.proto", 1047,
